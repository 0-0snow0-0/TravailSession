    ...
    internal class SingletonProjets
    {
        ...
        public void reload()
        {
            ...
            try
            {
                ...
                {
                    /*Si la conversion ne marche pas. Peut être que les dates doivent êtres convertient en string first*/
                    Projet projet = new Projet(r["numProjet"].ToString(), r["titre"].ToString(), Convert.ToDateTime(r["dateDebut"]), r["description"].ToString(), Convert.ToInt32(r["budget"]), Convert.ToInt16(r["nbrEmpRequis"]), Convert.ToDouble(r["totalSalaire"]), Convert.ToInt16(r["client"]), r["statut"].ToString());
                    listeProjets.Add(projet);
                }
